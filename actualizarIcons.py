        ...
        for line in file:
            ...
            if line.startswith('.nf-'):
                ...
                if class_name_match and icon_code_match:
                    ...
                    class_name = class_name.replace("nf_", "")
...
def generate_dart_code(classes_with_icons):
    dart_code = """// ignore_for_file: constant_identifier_names
...
"""
    ...
    for class_name, icon_code in classes_with_icons.items():
        dart_code += f'\tstatic const IconData nf_{class_name} = NFIconData(0x{icon_code});\n '
    dart_code +='\n}'
    return dart_code
